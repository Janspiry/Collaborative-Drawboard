    ...
    <div class="filter-container">
      <el-form>
        <el-form-item>
          ...
          style="color: #409eff" size="medium" v-if="hasPerm('user:add')" @click="showCreate">添加
          </el-button>
        </el-form-item>
      </el-form>
    </div>
    <el-table :data="list" v-loading.body="listLoading" element-loading-text="拼命加载中" border fit
      ...
      <el-table-column align="center" label="管理" width="220" v-if="hasPerm('user:update')">
        <template slot-scope="scope">
          <el-button type="text"
          icon="el-icon-set-up"
          style="color: #607d8b" size="medium" @click="showUpdate(scope.$index)">修改</el-button>
          <el-button type="text"
            icon="el-icon-delete"
            style="color: #fc5454"  size="medium" v-if="scope.row.userId!=userId "
