  ...
  methods: {
    ...
    sendEvent() {
      ...
      let obj={
        ...
        data : JSON.stringify(this.canvasObj),
        senderId :this.session.clientId,
      }
      // console.log('worker端发送信息/')
      socket.emit('report',obj);
    },
    ...
    sendSynchroEvent() {
      ...
      // console.log('其他端发送 请求同步/')
      socket.emit('synchroToServer',obj);
    },
    ...
    changePage(item, index) {
      ...
      // console.log('this.canvasIndex:',this.canvasIndex)
