package com.unknown.drawboard.util;

import com.alibaba.fastjson.JSONObject;
import com.unknown.drawboard.config.exception.CommonJsonException;
import com.unknown.drawboard.util.constants.Constants;
...
public class CommonUtil {
	...
	/**
	 * 将object list参数值转为jsonObject list
	 */
	public static List<JSONObject> objectList2jsonObjectList(List<Object> list) {
		List<JSONObject> ret=new ArrayList<>();
		for(Object i : list){
			JSONObject json=(JSONObject) JSONObject.toJSON(i);
			ret.add(json);
		}
		return ret;
	}
